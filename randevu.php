        ...
        <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="takvim.php" class="non-style-link-menu"><div><p class="menu-text">Oturumlarım</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select * from takvim inner join randevu on takvim.scheduleid=randevu.scheduleid inner join hasta on hasta.pid=randevu.pid inner join doktor on takvim.docid=doktor.docid  where  doktor.docid=$userid ");
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="time" class="form-label">Plan Zamani: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                        Bu kaydı silmek istiyor musunuz?<br><br>
