     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                     <a href="takvim.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Oturumlarım</p></div></a>
                 </td>
             </tr>
             <tr class="menu-row" >
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Oturumlarım</p>
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  takvim where docid=$userid;");
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <div class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49);margin-top: 5px;">Oturum planı</div>
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../img/icons/add.svg');">Bir oturum ekle</font></button>
                        </a>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        ...
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Oturumlarım (<?php echo $list110->num_rows; ?>) </p>
                    </td>
                ...
                $sqlmain= "select takvim.scheduleid,takvim.title,doktor.docname,takvim.scheduledate,takvim.scheduletime,takvim.nop from takvim inner join doktor on takvim.docid=doktor.docid where doktor.docid=$userid AND takvim.durum = TRUE";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Oturumu sil</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Yeni bir oturum ekle.</p><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                <form action="oturum-ekle.php" method="POST" class="add-new-form">
                                    <label for="title" class="form-label">Oturum Başlığı : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="title" class="input-text" placeholder="Oturum Başlığı" required><br>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Oturum Başlığı: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
